...
export class FormsComponent implements OnInit {
  ...
  uiModel = `
  <div class="container-fluid my-2" onInit="initHandler()">
      <div class="row mb-4">
        <!-- Credit card -->
        <div class="col-sm-6">
          <div class="card">
            <div class="card-header">
              <text text-style="h4">Credit Card</text>
            </div>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="ccnumber" type="text" placeholder="0000 0000 0000 0000"></input>
                  </div>
                </div>
              </div>
        ...
        <div class="col-sm-6">
          <div class="card">
            <div class="card-header">
              <text text-style="h4">Company</text>
              <text text-style="h6" class="ml-1">Form</text>
            </div>
            <div class="card-body">
              <div class="form-group">
      ...
      <div class="row mb-4">
        ...
        <div class="col-md-6">
          <div class="card mb-2">
            <div class="card-header">
              <text text-style="h4">Basic Form</text>
              <text text-style="h6" class="ml-1">Elements</text>
            </div>
            <div class="card-body">
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <text class="form-control-static">Username</text>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    ...
                    <text class="help-block">This is a help text</text>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    ...
                    <text class="help-block">Please enter your
                      email</text>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input class="form-control" id="password-input" type="password" name="password-input"
                      placeholder="Password" autocomplete="new-password" /><text class="help-block">Please enter a
                      complex
                      password</text>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input class="form-control" id="date-input" type="date" name="date-input" placeholder="date" /><text
                      class="help-block">Please enter a valid date</text>
                  </div>
                </div>
                <div class="form-group row">
          ...
          <div class="card">
            <div class="card-header">
              <text text-style="h4">Inline</text>
              <text text-style="h6" class="ml-1">Form</text>
            </div>
            <div class="card-body">
        ...
        <div class="col-md-6">
          <div class="card mb-2">
            <div class="card-header">
              <text text-style="h4">Horizontal</text>
              <text text-style="h6" class="ml-1">Form</text>
            </div>
            <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input class="form-control" id="hf-email" type="email" name="hf-email" placeholder="Enter Email.."
                      autocomplete="email" /><text class="help-block">Please enter your email</text>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input class="form-control" id="hf-password" type="password" name="hf-password"
                      placeholder="Enter Password.." autocomplete="current-password" /><text class="help-block">Please
          ...
          <div class="card mb-2">
            <div class="card-header">
              <text text-style="h4">Normal</text>
              <text text-style="h6" class="ml-1">Form</text>
            </div>
            <div class="card-body">
              <form action="" method="post">
                ...
                <div class="form-group">
                  ...
                  <text class="help-block">Please enter your password</text>
                </div>
              </form>
            </div>
            <div class="card-footer">
          ...
          <div class="card mb-2">
            <div class="card-header">
              <text text-style="h4">Input</text>
              <text text-style="h6" class="ml-1">Grid</text>
            </div>
            <div class="card-body">
              <form class="form-horizontal" action="" method="post">
                <div class="form-group row">
          ...
          <div class="card">
            <div class="card-header">
              <text text-style="h4">Input</text>
              <text text-style="h6" class="ml-1">Sizes</text>
            </div>
            <div class="card-body">
              <form class="form-horizontal" action="" method="post">
                <div class="form-group row">
      ...
      <div class="row mb-4">
        <div class="col-sm-6">
          <div class="card">
            <div class="card-header">
              <text text-style="h4">Validation states</text>
              <text text-style="h6" class="ml-1">Form</text>
            </div>
            <div class="card-body">
              <div class="form-group">
        ...
        <div class="col-sm-6">
          <div class="card">
            <div class="card-header">
              <text text-style="h4">Validation</text>
              <text text-style="h6" class="ml-1">was-validated</text>
            </div>
      ...
      <div class="row mb-4">
        <div class="col-sm-4">
          <div class="card">
            <div class="card-header">
              <text text-style="h4">Icon/Text</text>
              <text text-style="h6" class="ml-1">Groups</text>
            </div>
            <div class="card-body">
              <form class="form-horizontal" action="" method="post">
                <div class="form-group row">
                  ...
                  <div class="col-md-12">
                    <div class="input-group">
                      ...
                      <div class="input-group-append">
                        <div class="input-group-text">
                          <icon class="fa fa-envelope-open-o"></icon>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-header">
              <text text-style="h4">Buttons</text>
              <text text-style="h6" class="ml-1">Groups</text>
            </div>
            <div class="card-body">
              <form class="form-horizontal" action="" method="post">
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-header">
              <text text-style="h4">Dropdowns</text>
              <text text-style="h6" class="ml-1">Groups</text>
              ...
              <form class="form-horizontal" action="" method="post">
                <div class="form-group row">
                  <div class="col-md-12">
                    <!-- <div class="input-group">
                    <div class="input-group-prepend">
                      <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Action<span
                          class="caret"></span></button>
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a>
                        <a class="dropdown-item" href="#">Something else here</a>
                        <div class="dropdown-divider" role="separator"></div><a class="dropdown-item" href="#">Separated
                          link</a>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="input-group-prepend">
                      ...
                      <div class="dropdown-menu"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item"
      ...
      <div class="row mb-4">
        <div class="col-md-6">
          <div class="card">
            <div class="card-header">
              <text>Use the grid for big devices!</text>
              <text font-size="0.8rem" color="red">.col-lg-* .col-md-* .col-sm-*</text>
            </div>
            <div class="card-body">
              <form class="form-horizontal" action="" method="post">
                <div class="form-group row">
        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-header">
              <text>Input Grid for small devices!</text>
              <text font-size="0.8rem" color="red">.col-*</text>
            </div>
            <div class="card-body">
              <form class="form-horizontal" action="" method="post">
                <div class="form-group row">
              ...
              <form class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="controls">
                    ...
                    <text class="help-block">Here's some help text</text>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="controls">
                    ...
                    <div class="help-block">Here's more help text</div>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <div class="input-group">
                      ...
                      <div class="input-group-append">
                        <button class="btn btn-secondary" type="button">Go!</button></div>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="controls">
                    <div class="input-group">
                      ...
                      <div class="input-group-append">
                        ...
                        <button class="btn btn-secondary" type="button">Options</button></div>
                    </div>
                  </div>
                </div>
